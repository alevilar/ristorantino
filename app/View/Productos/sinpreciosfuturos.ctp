...
<h2><?php echo __('Productos sin precios futuros');?></h2>
<p>
<?php
/*
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Borrar'), array('action'=>'delete', $producto['Producto']['id']), null, sprintf(__('¿Esta seguro que desea borrar "%s"?'), $producto['Producto']['name'])); ?>
		</td>
	</tr>
<?php
        }
...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Aplicar precios futuros'), array('action'=>'actualizarPreciosFuturos'), null, sprintf(__('¿Esta seguro que desea actualizar los precios futuros?'))); ?></li>
		<li><?php echo $this->Html->link(__('Listar Productos'), '/productos/index'); ?></li>
                <li><?php echo $this->Html->link(__('Productos con precios futuros'), array('controller'=>'productos_precios_futuros','action'=>'index')); ?></li>
        </ul>
</div>
