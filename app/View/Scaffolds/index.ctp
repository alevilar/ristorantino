...
foreach (${$pluralVar} as ${$singularVar}):
	echo '<tr>';
		...
		<div class="btn-group">
		<?php
		echo $this->Html->link(__d('cake', 'View'), array('action' => 'view', ${$singularVar}[$modelClass][$primaryKey]), array('class'=>'btn btn-default'));
		echo ' ' . $this->Html->link(__d('cake', 'Edit'), array('action' => 'edit', ${$singularVar}[$modelClass][$primaryKey]), array('class'=>'btn btn-default'));
