...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Iva Responsabilidad'), array('action' => 'delete', $ivaResponsabilidad['IvaResponsabilidad']['id']), null, __('Are you sure you want to delete # %s?', $ivaResponsabilidad['IvaResponsabilidad']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($ivaResponsabilidad['Cliente'] as $cliente): ?>
		<tr>
