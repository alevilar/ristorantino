...
<h2><?php echo __('Tipos de Documentos');?></h2>
<p>
<?php
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Borrar'), array('action' => 'delete', $tipoDocumento['TipoDocumento']['id']), null, sprintf(__('Are you sure you want to delete # %s?'), $tipoDocumento['TipoDocumento']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Crear nuevo Tipo de documento'), array('action' => 'add')); ?></li>
	</ul>
</div>
