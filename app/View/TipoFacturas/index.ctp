<div class="tipoFacturas index">
	<h2><?php echo __('Tipo Facturas');?></h2>
	...
	<tr>
		<td><?php echo h($tipoFactura['TipoFactura']['id']); ?>&nbsp;</td>
		<td><?php echo h($tipoFactura['TipoFactura']['name']); ?>&nbsp;</td>
		<td><?php echo h($tipoFactura['TipoFactura']['codename']); ?>&nbsp;</td>
		<td><?php echo h($tipoFactura['TipoFactura']['created']); ?>&nbsp;</td>
		<td><?php echo h($tipoFactura['TipoFactura']['modified']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $tipoFactura['TipoFactura']['id']), null, __('Are you sure you want to delete # %s?', $tipoFactura['TipoFactura']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
