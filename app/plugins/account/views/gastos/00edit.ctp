<?php
echo $html->css('/account/jquery-ui-1.10.3.custom/css/ui-lightness/jquery-ui-1.10.3.custom.min');
echo $javascript->link('/account/jquery-ui-1.10.3.custom/js/jquery-ui-1.10.3.custom.min');
?>    
<div class="gastos form">
    ...
    <div class="ui-grid-a">
        ...
        <div class="ui-block-a">
            ...
            echo $form->input('proveedor_list', array('label' => 'Proveedor', 'type' => 'text', 'id'=>'proveedores', 'class'=>'auto-complete'));
