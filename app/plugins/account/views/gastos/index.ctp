...
<tr>
	...
	<th><?php echo $paginator->sort('tipo_factura_id');?></th>
	...
	<th><?php echo $paginator->sort('iva_a');?></th>
	<th><?php echo $paginator->sort('iva_b');?></th>
	<th><?php echo $paginator->sort('iibb');?></th>
	<th><?php echo $paginator->sort('imp_int');?></th>
	<th><?php echo $paginator->sort('percep_iva');?></th>
	<th><?php echo $paginator->sort('no_gravado');?></th>
	<th><?php echo $paginator->sort('otros');?></th>
