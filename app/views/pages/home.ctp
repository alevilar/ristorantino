...
<div id='botonera_home' class="menu-horizontal grid_10 prefix_2">
    <div class="grid_5">
        <?php echo $html->link('Adición','/adition/adicionar',array('class'=>'boton redondeado','style'=>'margin:auto;', 'id'=>'bton-adicion'));?>
	<?php echo $html->link('Admin','/pages/administracion',array('class'=>'boton redondeado','style'=>'margin:auto;', 'id'=>'bton-admin'));?>
    </div>
