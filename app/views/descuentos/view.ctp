...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit Descuento', true), array('action'=>'edit', $descuento['Descuento']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete Descuento', true), array('action'=>'delete', $descuento['Descuento']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $descuento['Descuento']['id'])); ?> </li>
