...
App::uses('StatsAppController', 'Stats.Controller');
...
class StatsController extends StatsAppController 
{
    ...
    public $uses = array('Mesa.Mesa', 'Mesa.Pago', 'Account.Egreso', 'Account.Gasto', 'Cash.Zeta','Mesa.TipoDePago');
     ...
     * 
     */
    public function mesas_total($groupByRange = 'day')
    {
        $egresos = array();
