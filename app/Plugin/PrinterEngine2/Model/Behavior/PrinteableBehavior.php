...
App::uses('ViewPrintTemplates', 'PrinterEngine.ViewPrintTemplates');
 ...
 */    
  ...
  */
    ...
    public function setup(){
        ...
        $this->_loadEngine( $this->defaultOutput );
 ...
 */
    public function _loadEngine( $outputType ) {
 ...
 */    
    private function _send($texto, $printer ) {
        ...
        $this->Engine->send( $texto, $printer, $hostname );
    }
 ...
 */    
    ...
    public function imprimirTicket( $data = null, $impresoraName = null) {
        $viewName = 'PrinterEngine.ReceiptPrinter/ticket' ;
        $View = new View();
        $View->set($data);            
        
        $result = $View->render($viewName, false);      
    }
