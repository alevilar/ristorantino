...
/**
 * Constructor method
 * Select the correct driver based on configuration params
 *  
 */        
        function __construct(){
            ...
            App::uses($modeloImpresoraFiscal, 'PrinterEngine.FiscalPrinter/Driver');
...
/**
 * Gets the printer Driver's name
 * 
 * @return string 
 */        
