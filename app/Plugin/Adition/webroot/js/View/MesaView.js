R$.View.Mesa = Backbone.View.extend({
    ...
    render: function(){
        ...
        this.renderHeader().renderFooter().renderId();
        
        var newEstadoClass = "estado_"+this.model.get('estado_id');
        if (this.estadoClass != newEstadoClass) {
            this.$el.removeClass(this.estadoClass);
            this.estadoClass = newEstadoClass;
            this.$el.addClass(newEstadoClass);
        }
        return this;
    }
