...
$('#comanda-add-menu').live('pageshow',function(event, ui){ 
        ...
        $('a','#listado_productos').bind('mouseover', function(){
       ...
       $('a','#listado_productos').live('mouseout', function(){
           setTimeout(function(){
                if ( !enProductoDetalle ) {
                    var href = this.getAttribute('href');                
        ...
        $('a', '#listado_categorias').live('tap', function(e){
            e.preventDefault();
        ...
        $('a','#listado_categorias').bind('mouseout', function(e){
...
// enrquiqueecr con JQM el listado ed comandas de la mesa en msa-view
$('#comanda-add-menu').live('pagehide',function(event, ui){ 
