...
( 1, 'imprimePrimeroRemito', '1', 'Esta variable sirve para imprimir siempre un comprobante de consumicion antes de imprimir el ticket los valores posibles son 1 o 0 (para imprimir directamente la factura)', NULL, '2012-01-13 22:12:39'),
( 2, 'name', 'Nombre Comercio', 'Generalmente utilizado para las impresiones extra como remitos e informes', NULL, '2012-11-28 21:36:07'),
...
( 1, 'tituloMesa', 'Mesa', '', NULL, '2012-11-28 21:36:24'),
( 1, 'tituloMozo', 'Mozo', '', NULL, '2012-11-28 21:36:46'),
( 4, 'cantidadCubiertosObligatorio', '0', '', NULL, '2012-11-28 21:36:59'),
...
( 3, 'encoding', '', 'encoding para las impresoras, de esta forma saldrán los acentos. Lo que no funciona es la "Ñ" mayúscula', NULL, '2011-11-15 20:23:03'),
( 4, 'reload_interval', '3700', 'valor en milisegundos de actualizacion de nuevas mesas', NULL, '2012-11-28 21:37:22'),
( 4, 'reload_interval_timeout', '60000', 'valor en milisegundos que debe esperar el ajax para actualizar las mesas. Si el ajax no se resuelve. entonces se termina a la fuerza.', NULL, '2012-11-28 21:37:29'),
( 4, 'jqm_page_transition', '1', 'activar animaciones\r\n', NULL, '2012-11-28 21:37:44'),
( 3, 'server', 'auto', '', NULL, '2012-11-28 22:19:51'),
( 3, 'nombre', 'fiscalprinter', 'nombre de la impresora CUPS, es la impresora fiscal que para CUPS será una impresora que imprima "raw" en una carpeta particular donde estará leyendo el spooler', NULL, '2011-11-15 21:33:01'),
( 1, 'prueba', '1111111', '', '2011-11-04 09:21:31', '2011-11-04 09:21:31'),
( 2, 'valorCubierto', '0', '', '2011-11-06 17:55:21', '2011-11-15 20:10:11'),
( 2, 'mail', 'info@mail.com.ar', '', '2011-11-22 20:13:01', '2012-11-25 00:02:17'),
( 4, 'preTicketHeader', '            COMPROBANTE DE CONSUMICION', '', '2011-11-22 20:13:38', '2011-11-22 20:13:38'),
( 3, 'precision', '2', 'Cantidad de decimales a mostrar en los totales y en el ticket', NULL, NULL),
( 1, 'usar_generica', '1', 'va 0 o 1 dependiendo si quiero mostrar y adicionar con mesa generica (usa por defecto mozo 99, numero de mesa 99, y cero cubiertos para abrir la mesa generica)', NULL, NULL),
( 1, 'generica_name', 'Kiosko', 'Nombre generico para abrir mesas que sean de pronta atencion', NULL, NULL),
( 1, 'generica_mozo_id', '1', 'ID del mozo a utilizar como generico, generalmente tratamos de crear un mozo con numero 99 y usar ese. Pero por defecto el sistema usa el mozo con ID:1, que, por defecto es el mozo de identico numero (el 1)', NULL, NULL)
;
